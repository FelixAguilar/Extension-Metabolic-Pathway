...
def add_arrow(self, element_A, element_B):
    ...
    add_straight_arrow(self, id_B, id_A, coordinates_B, coordinates_A, False)
...
class Constructor(inkex.EffectExtension):
    ...
    def effect(self):
        ...
        # Obtains all the paths that connects the selection with the rest.
        inter_path = []
        for element in self.svg.selection:
            id = element.get_id()
